/*
  ...
  History
    ...
    1.2.0 31/10/2015:   Added function and interval parameter
  =======================================================
*/
#ifndef HBUS_SENSOR_DHT_H
#define HBUS_SENSOR_DHT_H
#define VERSION_HBUS_SENSOR_DHT_H   "1.2.0"
...
class SensorDht : public Sensor {
  ...
  public:
    ...
    SensorDht(char* name, uint8_t pin, uint8_t model, uint8_t temperature, uint16_t interval);
    //========================================================
    //Methods
    //========================================================
    char* status();
...
SensorDht::SensorDht(char* name, uint8_t pin, uint8_t model, uint8_t temperature, uint16_t interval) {
